 ...
 * Network Stats
 */
class _network extends \IPS\Dispatcher\Controller
{
	const PER_PAGE = 25;
	...
	{
		\IPS\Dispatcher::i()->checkAcpPermission( 'network_manage' );
		parent::execute();
	}
	...
	protected function manage()
	{
		...
		\IPS\Output::i()->output .= \IPS\Theme::i()->getTemplate('stats')->networkTable( $select, $pagination, $members );
		\IPS\Output::i()->title = \IPS\Member::loggedIn()->language()->addToStack('menu__bitracker_stats_network');
	}
}